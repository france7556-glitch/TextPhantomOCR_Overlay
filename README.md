...
*Note2: ส่วนขยายนี้เป็นแค่การอัพโหลดไปที่ google translate image เพื่อให้มันแปลภาพให้ครับ มันเลยแปลได้ตรงตัวเหมือนที่เราแปลภาพใน translate ปกติ ยกเว้นหมวด AI ที่เป็นการดึงข้อมูล ocr มาให้ Ai แปลและแปะกลับที่ผมทำขึ้นมาเองครับ ถึงแม้ว่าจะมีที่ดีกว่านี้คือ "[manga-image-translator](https://github.com/zyddnys/manga-image-translator)" ซึ่งมันจะดีกว่าของผมตรงที่องศาของภาษาที่แปลถูกหมุนให้ถูกต้องและแบ่งข้อความได้ดีแต่ข้อเสียคือมันช้าครับ ในอนาคตจะพยายามเลียนแบบการทำงานอยู่ครับ* 
